(function (global, factory) {
	...
	(factory((global.TmLabs = global.TmLabs || {}),global.os,global.url,global.http,global.https,global.zlib,global.require$$1,global.require$$0,null,global.util,global.fs,global.crypto));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (options.key !== undefined && typeof options.key === 'string') this._map.get(this).key = options.key;else if (process.env.TMLABS_KEY) this._map.get(this).key = process.env.TMLABS_KEY;
